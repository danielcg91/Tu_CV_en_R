# Este archivo contiene todo el código necesario para analizar e imprimir varias secciones de su CV
# de datos. ¡Siéntete libre de modificarlo como desees!


#' Crea un objeto CV_Printer.
#'
#' @param data_location Ruta de las hojas de cálculo que contienen todos sus datos. Esto puede ser
#' ya sea una URL a una hoja de Google con varias hojas que contienen las cuatro
#' tipos de datos o una ruta a una carpeta que contiene cuatro `.csv`s con lo necesario
#' datos.
