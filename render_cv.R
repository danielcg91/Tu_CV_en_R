# Este script crea las versiones HTML y PDF de tu CV
...
# Codigo version anteriores https://github.com/mpadilla905/mpadilla905.github.io/blob/master/cv_printing_functions.r
